            ...
            <div className="menu-container">
                <div className="menu-container icon">
                    <div className="basicons" onClick={handleClick} id="element">
                        ...
                        <path d="M13.2 12H8M13.2 12C14.7464 12 16 10.8807 16 9.5C16 8.11929 14.7464 7 13.2 7H8V17H13.2C14.7464 
                        17 16 15.8807 16 14.5C16 13.1193 14.7464 12 13.2 12Z" stroke="#fff" stroke-width="2" stroke-linecap="round" 
                ...
                {click && <div className="navbar">
                    <ul className="basicons-menu">
                        <li className="nav-item"> 
                            <a href="#" className="nav-link"> 
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M3 14V20C3 21.1046 3.89543 22 5 22H19C20.1046 22 21 21.1046 21 20V14" stroke="#fff" 
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M12 3V17M12 17L7 11.5555M12 17L17 11.5556" stroke="#fff" 
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            Download 326 Icons</a>
                        </li>
                        <li className="nav-item">
                            <a href="#" className="nav-link"> 
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li className="nav-item">
                            <a href="#" className="nav-link"> 
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2 9H18V19C18 20.6569 16.6569 22 15 22H5C3.34315 22 2 20.6569 2 19V9Z" stroke="#fff" 
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M18 11H18.9098C20.6165 11 22 12.3835 22 14.0902V14.0902C22 15.2606 21.3387 16.3307 20.2918 16.8541L18 18" 
